...
```bash
# Test case 1: kill the pod while still on 1.11
...
This looks ok, let's disable the webhook, and try with a modification of the QP spec:
...
pod/deployment-upgrade-failure-00001-deployment-5b8684978c-g6rkb   2/2     Running   0          9m4s
```
...
* Knative Service stays “ready=true”
